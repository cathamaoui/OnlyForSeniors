...
const steps = [
  { n: "1", title: "Send us your details", body: "Email hello@onlyforseniors.ca with your business name, services, service area, and a phone or email. We do the rest." },
  { n: "2", title: "We build & verify your profile", body: "Our team creates your profile, uploads your photos, confirms your categories, and verifies your contact info. Free during launch." },
  { n: "3", title: "Go live & start getting calls", body: "Your profile is published in the right categories. Seniors searching for your service see you — and can call, message, or email directly." },
  { n: "4", title: "Grow with reviews", body: "After each job, ask the family or senior to leave a review. Verified reviews lift you to the top of search over time." },
];
...
const faqs = [
  ...
  { q: "How are reviews moderated?", a: "Reviews are written by verified seniors and families. We flag and remove anything that looks fake, abusive, or posted by competitors." },
];
...
export default function ForBusinessesPage() {
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="bg-white border-b border-stone-200">
        <div className="max-w-5xl mx-auto px-4 py-12 sm:py-16 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/list-business/"
              className="inline-flex items-center justify-center gap-2 min-h-touch px-7 py-4 bg-stone-900 text-white text-lg font-bold rounded-full border border-stone-900 hover:bg-black transition-colors"
            >
              Post a Listing — $10/mo <ArrowRight className="w-5 h-5" />
            </Link>
            <a
              href="mailto:hello@onlyforseniors.ca"
              className="inline-flex items-center justify-center gap-2 min-h-touch px-7 py-4 bg-white text-stone-900 text-lg font-bold rounded-full border border-stone-200 hover:bg-stone-50 hover:border-stone-900 transition-colors"
            >
      ...
      {/* WHY IT WORKS — STAT STRIP (monochrome) */}
        ...
        <div className="max-w-5xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <ul className="space-y-2">
            {whoPosts.map((w) => (
              ...
              >
                <span aria-hidden="true" className="inline-flex items-center justify-center w-5 h-5 bg-stone-900 text-white rounded-md flex-shrink-0 mt-0.5">
                  <Check className="w-3 h-3" strokeWidth={3} />
                </span>
                <span className="text-stone-900 font-medium">{w}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="bg-white border-y border-stone-200">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <div className="bg-stone-50 border border-stone-200 rounded-2xl p-8 max-w-md mx-auto text-left">
            ...
            <ul className="mt-5 space-y-3 text-stone-900">
              {[
                "Full business profile",
                "Listed in all relevant categories",
                "Direct contact from seniors",
                "Reviews & ratings",
                "Profile analytics",
                "Cancel anytime",
              ].map((line) => (
            ...
            <Link
              href="/list-business/"
              className="mt-6 inline-flex w-full items-center justify-center gap-2 min-h-touch px-6 py-3 bg-stone-900 text-white text-lg font-bold rounded-full border border-stone-900 hover:bg-black"
            >
          ...
          {faqs.map((f) => (
            ...
            >
              <summary className="cursor-pointer list-none px-5 py-4 font-bold text-stone-900 flex items-center justify-between">
                {f.q}
                <span aria-hidden="true" className="ml-3 text-stone-500 group-open:rotate-45 transition-transform text-2xl leading-none">
                  +
                </span>
              </summary>
              <p className="px-5 pb-5 text-stone-700 leading-relaxed">{f.a}</p>
            </details>
          ))}
        </div>
      </section>
      ...
      <section className="bg-stone-900 text-white">
        <div className="max-w-4xl mx-auto px-4 py-14 sm:py-20 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/list-business/"
              className="inline-flex items-center justify-center gap-2 min-h-touch px-7 py-4 bg-white text-stone-900 text-lg font-bold rounded-full border border-white hover:bg-stone-100"
            >
              Post a Listing — $10/mo <ArrowRight className="w-5 h-5" />
            </Link>
            <a
              href="mailto:hello@onlyforseniors.ca"
              className="inline-flex items-center justify-center gap-2 min-h-touch px-7 py-4 bg-stone-800 text-white text-lg font-bold rounded-full border border-white hover:bg-stone-700"
            >
              <Mail className="w-5 h-5" /> hello@onlyforseniors.ca
            </a>
          </div>
          <p className="mt-6 text-base text-stone-300 flex items-center justify-center gap-2 flex-wrap">
