  ...
  return (
    <div className="min-h-screen bg-cream">
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16">
        <h1 className="font-display font-medium text-4xl sm:text-5xl text-stone-900 mb-6">Terms of Service</h1>
        <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 text-stone-900 space-y-4 leading-relaxed">
          ...
          <h2 className="font-display font-medium text-2xl text-stone-900">For users (seniors)</h2>
          ...
          <h2 className="font-display font-medium text-2xl text-stone-900">For business owners</h2>
          <ul className="list-disc pl-6 space-y-1 text-stone-700">
