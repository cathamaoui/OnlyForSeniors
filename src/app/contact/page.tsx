      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
          ...
          <form className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border-2 border-stone-300 rounded focus:border-blue-700 focus:outline-none"
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm font-semibold mb-1">What's this about?</label>
              <select className="w-full px-3 py-2 border-2 border-stone-300 rounded focus:border-blue-700 focus:outline-none bg-white">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white border border-stone-200 rounded-lg p-5 text-center">
            ...
            <a href="mailto:hello@onlyforseniors.ca" className="text-sm text-stone-700 hover:underline block">
          ...
          <div className="bg-white border border-stone-200 rounded-lg p-5 text-center">
            ...
            <p className="text-sm text-stone-700">Coming soon</p>
          </div>
          <div className="bg-white border border-stone-200 rounded-lg p-5 text-center">
